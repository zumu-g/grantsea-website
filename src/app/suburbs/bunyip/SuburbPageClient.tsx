...
export default function BunyipSuburbPage() {
  ...
  const suburbProperties = properties.filter(p =>
    p.address?.toLowerCase().includes('bunyip')
  ).slice(0, 3);
  ...
  const stats = [
    { label: 'Median House Price', value: '$600,000' },
    { label: 'Distance to CBD', value: '90km' },
    { label: 'Population', value: '2,600+' },
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Charming Country Town with Rich Heritage & Spirit
          </p>
        </div>
      </section>
        ...
        <div style={{ flex: 1 }}>
          ...
          <section id="overview" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip stands as one of Melbourne's most charming and historically rich southeastern towns, perfectly
              balancing rural heritage with modern suburban convenience. Located approximately 90 kilometres from
              Melbourne's CBD within the Shire of Cardinia, Bunyip has maintained its distinctive identity as a
            ...
            <p style={{
              ...
              sacrificing accessibility. The name Bunyip derives from an Aboriginal term meaning "devil" or "spirit",
          ...
          <section id="location" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip occupies a strategic position in Melbourne's southeast growth corridor, bordered by Tynong
              to the west, Longwarry to the east, and the Cardinia Shire to the north. This location provides
            ...
            <div style={{
              ...
              <div style={{
                ...
                {['Tynong', 'Longwarry', 'Garfield', 'Drouin'].map(suburb => (
          ...
          <section id="lifestyle" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip's lifestyle appeal centres on its country atmosphere, established parks, and strong community
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  shopfronts, local cafes, and community facilities, preserving the area's rich history.
                </p>
              </div>
              <div style={{
                backgroundColor: '#fff',
                ...
                <p style={{
                  ...
                  and enjoy the natural environment with established homes on generous blocks.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="education" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Education facilities in Bunyip are comprehensive and well-regarded, contributing significantly to
          ...
          <section id="transport" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip benefits from excellent transport connectivity anchored by the Pakenham railway line, which
          ...
          <section id="housing" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip's housing market is characterized by established homes on generous blocks, heritage properties,
          ...
          <section id="investment" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Bunyip's future development is carefully managed to preserve country character while accommodating
            ...
            <div style={{
              ...
              <div style={{
                ...
                {[
                  ...
                  'Strategic rural corridor location'
                ].map((factor, idx) => (
                  <div key={idx} style={{
                    display: 'flex',
                    alignItems: 'center',
          ...
          <section style={{
            ...
            <h2 style={{
              ...
              Discover Your Future in Bunyip
            </h2>
            <p style={{
              fontSize: '18px',
              marginBottom: '32px',
