...
export default function GarfieldSuburbPage() {
  ...
  const suburbProperties = properties.filter(p =>
    p.address?.toLowerCase().includes('garfield')
  ).slice(0, 3);
  ...
  const stats = [
    { label: 'Median House Price', value: '$650,000' },
    { label: 'Distance to CBD', value: '80km' },
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Historic Country Town with Rural Heritage Charm
          </p>
        </div>
      </section>
        ...
        <div style={{ flex: 1 }}>
          ...
          <section id="overview" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield stands as one of Melbourne's most charming and historically rich southeastern towns, perfectly
              balancing rural heritage with modern suburban convenience. Located approximately 80 kilometres from
              Melbourne's CBD within the Shire of Cardinia, Garfield has maintained its distinctive identity as a
              country town with strong agricultural roots while adapting to contemporary lifestyle needs.
            </p>
            <p style={{
              fontSize: '18px',
              lineHeight: '1.8',
              ...
              sacrificing accessibility. What makes Garfield particularly appealing is its successful preservation
          ...
          <section id="location" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield occupies a strategic position in Melbourne's southeast growth corridor, bordered by Bunyip
              to the west, Tynong to the east, and the Cardinia Shire to the north. This location provides residents
              with excellent connectivity to both Melbourne's CBD and the expanding outer southeastern suburbs, while
              maintaining separation from higher-density development.
            </p>
            <div style={{
              ...
              <div style={{
                ...
                {['Bunyip', 'Tynong', 'Pakenham', 'Nar Nar Goon'].map(suburb => (
          ...
          <section id="lifestyle" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield's lifestyle appeal centres on its country atmosphere, established parks, and strong community
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  The historic town centre creates a focal point for community life, with heritage shopfronts,
                  local cafes, and services providing venues for social interaction and community connection.
                </p>
              </div>
              <div style={{
                backgroundColor: '#fff',
                ...
                <p style={{
                  ...
                  The country setting provides opportunities for residents to engage in outdoor activities
                  and enjoy the natural environment, with extensive parks and recreational facilities.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="education" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Education facilities in Garfield are comprehensive and well-regarded, contributing significantly to
          ...
          <section id="transport" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield benefits from excellent transport connectivity anchored by the Pakenham railway line, which
          ...
          <section id="housing" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield's housing market is characterized by established homes on generous blocks, heritage properties,
              and quality residential developments that respect the suburb's country character. The housing stock
            ...
            {suburbProperties.length > 0 && (
              <div style={{ marginBottom: '48px' }}>
                <h3 style={{
                  ...
                  Current Properties in Garfield
                </h3>
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)',
          ...
          <section id="investment" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Garfield's future development is carefully managed to preserve country character while accommodating
            ...
            <div style={{
              ...
              <div style={{
                ...
                {[
                  'Historic country character with heritage appeal',
                  'Excellent Pakenham line railway connectivity',
                  'Strong rental demand from tree-changers',
          ...
          <section style={{
            ...
            <h2 style={{
              ...
              Discover Your Future in Garfield
            </h2>
            <p style={{
              fontSize: '18px',
              marginBottom: '32px',
              ...
              Let our local experts help you find the perfect property in this historic country town.
            </p>
            <div style={{
              display: 'flex',
              gap: '16px',
