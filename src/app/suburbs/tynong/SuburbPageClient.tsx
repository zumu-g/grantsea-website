...
export default function TynongSuburbPage() {
  ...
  const suburbProperties = properties.filter(p =>
    p.address?.toLowerCase().includes('tynong')
  ).slice(0, 3);
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Historic Country Town with Tranquil Rural Atmosphere
          </p>
        </div>
      </section>
        ...
        <div style={{ flex: 1 }}>
          ...
          <section id="overview" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong stands as one of Melbourne's most tranquil and historically rich southeastern towns, perfectly
              balancing rural heritage with modern suburban convenience. Located approximately 85 kilometres from
              Melbourne's CBD within the Shire of Cardinia, Tynong has maintained its distinctive identity as a
            ...
            <p style={{
              ...
              sacrificing accessibility. What makes Tynong particularly appealing is its successful preservation
          ...
          <section id="location" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong occupies a strategic position in Melbourne's southeast growth corridor, bordered by Garfield
              to the west, Bunyip to the east, and the Cardinia Shire to the north. This location provides residents
            ...
            <div style={{
              ...
              <div style={{
                ...
                {['Garfield', 'Bunyip', 'Nar Nar Goon', 'Pakenham'].map(suburb => (
          ...
          <section id="lifestyle" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong's lifestyle appeal centres on its country atmosphere, established parks, and strong community
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  and enjoy the natural environment with mature gardens and established streetscapes.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="education" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Education facilities in Tynong are comprehensive and well-regarded, contributing significantly to
          ...
          <section id="transport" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong benefits from excellent transport connectivity anchored by the Pakenham railway line, which
          ...
          <section id="housing" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong's housing market is characterized by established homes on generous blocks, heritage properties,
          ...
          <section id="investment" style={{ marginBottom: '80px' }}>
            ...
            <p style={{
              ...
              Tynong's future development is carefully managed to preserve country character while accommodating
            ...
            <div style={{
              ...
              <div style={{
                ...
                {[
                  'Historic country character with heritage buildings',
                  ...
                  'Growing tourism and country lifestyle appeal',
                  'Strategic location in rural corridor'
                ].map((factor, idx) => (
                  <div key={idx} style={{
                    display: 'flex',
                    alignItems: 'center',
          ...
          <section style={{
            ...
            <h2 style={{
              ...
              Discover Your Future in Tynong
            </h2>
            <p style={{
              fontSize: '18px',
              marginBottom: '32px',
