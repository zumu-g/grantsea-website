...
export default function HomePageOncom() {
  ...
  const { properties, loading } = useProperties({ limit: 6, type: 'sale' }); // Use sale type for faster, more reliable loading
          ...
          <div style={{
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '12px' }}>
                  <Link href="/property-values" style={{ color: '#666', textDecoration: 'none', fontSize: '13px', transition: 'color 0.2s' }}
                    onMouseEnter={(e) => e.currentTarget.style.color = '#000'}
                    onMouseLeave={(e) => e.currentTarget.style.color = '#666'}>
                    Market Report
                  </Link>
