...
import PropertyEstimateCalculator from '@/components/PropertyEstimateCalculator';
...
export default function BerwickSuburbGuide() {
  ...
  return (
    <>
      ...
      <main style={{ paddingTop: isMobile ? '90px' : '200px', backgroundColor: '#fff' }}>
        ...
        <article style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <section id="section-4" style={{
            ...
            {/* Property Estimate Calculator CTA */}
            <div style={{
              backgroundColor: '#000',
              color: '#fff',
              ...
              <p style={{
                ...
                Get a free instant property estimate based on recent sales in your area
              </p>
              <button
      ...
      {/* Property Estimate Calculator Modal */}
