...
export default function BuyPageOncom({ initialProperties = [] }: { initialProperties?: any[] }) {
  ...
  const { properties: fetchedProperties, loading } = useProperties({
    type: 'sale',
    limit: currentLimit
  });
  // Server-fetched page 1 renders in initial HTML; client fetch takes over once it resolves
