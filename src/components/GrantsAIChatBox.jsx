...
const GrantsAIChatBox = ({ isFloating = false, initialPosition = { bottom: '20px', right: '20px' }, zIndexOffset = 0 }) => {
  ...
  const [messages, setMessages] = useState([
    { 
      text: isFloating 
        ? "Welcome! I'm your dedicated property specialist. I can provide detailed market insights, investment opportunities, and personalized property recommendations. What are you looking for?" 
        : "Hello! I'm Grant's AI Assistant. I can help you find properties, schedule viewings, or answer questions about the real estate market in Melbourne's Southeast. How can I assist you today?", 
      isUser: false 
    }
  ]);
  ...
  // Handle dragging for floating chat
    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          style={{
            position: 'fixed',
            bottom: initialPosition.bottom || '20px',
            right: initialPosition.right || '20px',
            width: '56px',
            height: '56px',
            borderRadius: '50%',
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600' }}>{isFloating ? "Grant's AI Assistant" : "Grant's AI"}</h3>
                <p style={{ margin: 0, fontSize: '12px', color: '#6b7280' }}>{isFloating ? 'Property specialist' : 'Always here to help'}</p>
              </div>
            </div>
            <button
            ...
            {messages.map((message, index) => (
              ...
              >
                <div style={{
                  ...
                  {message.isUser ? 'U' : (isFloating ? 'P' : 'G')}
                </div>
                <div
                  style={{
